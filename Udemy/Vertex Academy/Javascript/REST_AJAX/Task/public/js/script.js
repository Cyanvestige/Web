...
addForm.addEventListener('submit',function(e){
    ...
    }).then((response)=>response.text()).then((data)=>console.log("aaa"));
})
...
updateForm.addEventListener('submit',function(e){
    ...
    }).then((response)=>response.text()).then((data)=>console.log("updated"));
})
...
deleteForm.addEventListener('submit',function(e){
    ...
    fetch('http://localhost:3000/products/' + id,{
        method:'DELETE'
    }).then((response)=>response.text()).then((data)=>console.log('Deleted'));
})